...
## Product Category  
###   
ID: `mint_system.ir_model.product_category.`  
```xml
<?xml version='1.0' encoding='UTF-8' ?>
<odoo>
...
ID: `mint_system.ir_model.xml.*`  
```xml

```
Source: [snippets/ir_model.xml.*.xml](https://github.com/Mint-System/Odoo-Development/tree/14.0/snippets/ir_model.xml.*.xml)
